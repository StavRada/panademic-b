...
// board.add_station(City::Kinshasa);
// board.add_cure(Color::Black);
//
// cout<<boolalpha;
// cout<<board.is_station(City::Kinshasa)<<endl;
//  cout<<board.is_cure(City::Kinshasa)<<endl;
//
//  board.add_cure(Color::Yellow);
//  // cout<<boolalpha;
//
//   cout<<board.is_cure(City::MexicoCity)<<endl;
//
//
// 	cout<<board.is_connect(City::MexicoCity,City::LosAngeles)<<endl;
// 	cout<<board.is_connect(City::MexicoCity,City::Kinshasa)<<endl;
// 	std::cout << board << '\n';
//
// 	board.remove_cure();
// 	board.remove_stations();
// 	std::cout <<board.is_clean()<< '\n';
// 	board.remove_level_disease();
// 	std::cout <<board.is_clean()<< '\n';
//
	std::cout << board << '\n';
